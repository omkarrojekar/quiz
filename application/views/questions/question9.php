                        ...
                        <div class="col-sm-12">
                            <div class="element-wrapper">
                                ...
                                <form id="quiz-form" class="element-box" action="<?php echo base_url();?>home/storeanswers" method="POST">
                                  <label class="labeltext">Q9. What type of cancer treatment uses high energy waves to destroy cancer cells?</label>      
                                  <label class="customradio"><span class="radiotextsty">Surgery </span>
                                    <input type="radio" name="q9" value="Surgery">
                                    <span class="checkmark"></span>
                                  </label>
                                  <label class="customradio"><span class="radiotextsty">Chemotherapy </span>
                                    <input type="radio" name="q9" value="Chemotherapy">
                                    <span class="checkmark"></span>
                                  </label>
                                  <label class="customradio"><span class="radiotextsty">Radiation</span>
                                    <input type="radio" name="q9" value="Radiation">
                                    <span class="checkmark"></span>
                                  </label>
